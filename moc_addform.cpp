...
QT_MOC_LITERAL(23, 21), // "on_add_button_clicked"
QT_MOC_LITERAL(45, 22) // "on_back_button_clicked"

    },
    "AddForm\0mySignal\0\0text\0on_add_button_clicked\0"
...
void AddForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mySignal((*reinterpret_cast< const QList<QString>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (AddForm::*)(const QList<QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddForm::mySignal)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QList<QString> &, std::false_type>
...
// SIGNAL 0
void AddForm::mySignal(const QList<QString> & _t1)
{
